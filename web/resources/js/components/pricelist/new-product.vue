                        ...
                        <div class="col-10">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="package" min="1" required
                                       placeholder="Antal per Förpackning" v-model.number="product.package">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        ...
        computed: {
            sale_price() {
                return Math.ceil((this.product.purchase_price - this.product.discount) / this.product.package * 1.25 + (this.product.pant ? 1 : 0));
            }
        },
        methods : {
